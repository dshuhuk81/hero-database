...
const SUGGESTIONS_FILE = path.join(__dirname, './output/suggestions.json');
const SUGGESTIONS_DISMISSED_FILE = path.join(__dirname, './output/suggestionsDismissed.json');
const SUGGEST_SCRIPT = path.join(__dirname, 'suggest-synergy-tags.mjs');
const VIRTUE_SUGGESTIONS_FILE = path.join(__dirname, './output/suggestionsVirtues.json');
const VIRTUE_DISMISSED_FILE = path.join(__dirname, './output/suggestionsVirtuesDismissed.json');
const VIRTUE_SUGGEST_SCRIPT = path.join(__dirname, 'suggest-virtues.mjs');
const COMP_SUGGESTIONS_FILE = path.join(__dirname, './output/suggestionsComps.json');
const COMP_DISMISSED_FILE = path.join(__dirname, './output/suggestionsCompsDismissed.json');
