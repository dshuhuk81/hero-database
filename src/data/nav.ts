...
const allNavEntries: NavEntry[] = [
  ...
  },
  {
    ...
    teaser: true,
    description: {
      en: "Beginner tips and early game advice",
      de: "Anfängertipps und Ratschläge für den Spielstart",
      es: "Consejos para principiantes y para los primeros pasos",
      ru: "Советы для новичков и по началу игры",
      zh: "新手技巧与前期游戏建议",
    },
    badge: { text: { en: "Updated", de: "Aktualisiert", es: "Actualizado", ru: "Обновлено", zh: "已更新" }, color: "var(--accent-purple)", until: "2026-08-01" },
  ...
  },
  {
    ...
    teaser: true,
    description: {
      en: "Virtue sets, rarities and farming recommendations",
      de: "Tugenden-Sets, Seltenheiten und Farm-Empfehlungen",
      es: "Conjuntos de virtudes, rarezas y recomendaciones de farmeo",
      ru: "Наборы добродетелей, редкости и рекомендации по фарму",
      zh: "美德套装、稀有度与刷取建议",
    },
