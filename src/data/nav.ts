...
const allNavEntries: NavEntry[] = [
  ...
  },
  {
    ...
    sidebar: false,
    description: {
      en: "Bottle mini-game: chest strategy and shop priorities.",
  ...
  {
    label: "Votive Festival",
    href: "/guides/votive-festival",
    group: "content",
    sidebar: false,
    description: {
      en: "Lantern claw: time the hook and target Optional rewards.",
      de: "Woechentliches Laternen-Minispiel - Haken-Timing, Optional-Treffer und Shop-Prioritaet",
      es: "Minijuego semanal de garra con farolillos: cronometra el gancho, atrapa el Opcional y prioridad de la tienda",
      ru: "Еженедельная мини-игра с фонарями: тайминг крюка, добыча Опционального и приоритет магазина",
      zh: "每周灯笼抓取小游戏——把握摆钩时机、抢夺可选奖励与商店优先级",
    },
    badge: { text: { en: "New", de: "Neu", es: "Nuevo", ru: "Новое", zh: "新" }, color: "var(--accent-new)", until: "2026-09-01" },
    icon: `<path d="M14.7 3.3c2.5-.8 4.8-.5 6 .1.6 1.2.9 3.5.1 6l-6.4 6.4-6.2-6.2z"/><path d="m15.8 4.2 4 4"/><circle cx="15.8" cy="8.2" r="1.5"/><path d="M8.2 9.6 5 10.4 2.8 12.6l4.6.6M14.4 15.8l-.8 3.2-2.2 2.2-.6-4.6"/><path d="M8 16c-1.7.1-3.9 1.1-4.7 3.7 2.6-.8 3.6-3 3.7-4.7"/>`,
  },
  {
    label: "Benevolent Feast",
    href: "/guides/benevolent-feast",
    group: "content",
    sidebar: false,
    description: {
      en: "Take the Optional and reset; otherwise target Cattle.",
      de: "Woechentliches Wind-Minispiel - Tiere per Windstoss in den Hai treiben, und Shop-Prioritaet",
      es: "Minijuego semanal de viento: sopla los animales grandes hacia el tiburon y prioridad de la tienda",
      ru: "Еженедельная ветряная мини-игра: подбрасывайте крупных животных к акуле и приоритет магазина",
      zh: "每周吹风小游戏——把大型动物送进鲨鱼口中，以及商店优先级",
    },
    badge: { text: { en: "New", de: "Neu", es: "Nuevo", ru: "Новое", zh: "新" }, color: "var(--accent-new)", until: "2026-09-01" },
  ...
  },
  {
    ...
    description: {
      ...
      es: "Progresión naval, minería, saqueo PvP y estrategias de supervivencia",
      ru: "Развитие корабля, добыча руды, PvP-грабежи и стратегии выживания",
      zh: "战船养成、矿石开采、PvP掠夺与生存策略",
    },
    badge: { text: { en: "New", de: "Neu", es: "Nuevo", ru: "Новое", zh: "新" }, color: "var(--accent-new)", until: "2026-08-14" },
